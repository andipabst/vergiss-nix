...
object Notifications {
    ...
    fun showNotification(context: Context?, taskId: Long) {
        ...
        Executors.newSingleThreadExecutor().execute {
            ...
            openMainActivity.putExtra(EXTRA_TASK_ID, task.id)
            ...
            val markAsDone = Intent(context, NotificationBroadcastReceiver::class.java)
            markAsDone.action = NotificationBroadcastReceiver.ACTION_MARK_AS_DONE
            markAsDone.putExtra(EXTRA_TASK_ID, task.id)
